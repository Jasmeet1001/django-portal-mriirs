...
class ResearchPaper(models.Model):
    ...
    authors = models.CharField(max_length=400, null=False, blank=False)
    outside_authors = models.CharField(max_length=400, blank=True)
    domain = models.CharField(max_length=400, blank=True)
    title_of_paper = models.CharField(max_length=400, blank=True)
    dept = models.CharField(max_length=50, blank=True)
    name_of_journal = models.CharField(max_length=400, blank=True)
    name_of_conference = models.CharField(max_length=400, blank=True)
    title_of_book = models.CharField(max_length=400, blank=True)
    title_of_chapter = models.CharField(max_length=400, blank=True)
